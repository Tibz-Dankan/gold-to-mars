...
export const RocketSpeedometer: React.FC<SpeedometerProps> = ({
  ...
  return (
    <div className="relative w-48 h-24 flex items-center justify-center bg-violet-400s">
      {/* Gauge Circle */}
      ...
      {/* Needle */}
      <motion.div
        className="absolute origin-bottom w-1  h-16 bg-red-400 z-10"
        style={{ bottom: "0px" }}
        animate={{ rotate: `${rotation}deg` }}
        transition={{ type: "spring", stiffness: 100, damping: 10 }}
      />
      <label className="absolute bottom-8 text-[12px] text-gray-400 font-light">
        Meter
      </label>
